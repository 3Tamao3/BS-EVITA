...
{
    /// <summary>
    /// Interaktionslogik für TextInfo.xaml
    /// </summary>
    public partial class TextInfo : UserControl
    {
        ...
        public static readonly DependencyProperty IsActiveProperty = DependencyProperty.Register("TextTop", typeof(bool), typeof(TextInfo));
